...
Add books to the libraryÔÇÖs collection.
...
if __name__ == "__main__":
    ...
    print("\n­ƒôÜ **Stato iniziale della biblioteca:**")
    ...
    print("\n­ƒôû **Stato della biblioteca dopo il prestito dei libri:**")
    print(f"Libri disponibili: {', '.join(book.title for book in library.books)}")
    ...
    print("\n­ƒöä **Stato della biblioteca dopo la restituzione di un libro:**")
    print(f"Libri disponibili: {', '.join(book.title for book in library.books)}")
    print(f"Libri presi in prestito da {member1.name}: {', '.join(book.title for book in member1.borrowed_books)}")

    # Visualizzazione delle statistiche della biblioteca
    print("\n­ƒôè **Statistiche della biblioteca:**")
