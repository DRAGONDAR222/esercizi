'''Esercizio 8
Un'applicazione interessante dei computer ├¿ la rappresentazione grafica di dati.
...
print(str(my_list))             # cos├¼ facendo prima scrivo la lista nel terminale (poich├¿ viene scritta appena usciti dal ciclo "while")
