...
print(" inserisci un termine a tua scelta, se questo sar├á 'fine' il programma terminer├á")
while 1:                                                                                                # creo un ciclo while infinito
    x:str = input()                                                                                     # imposto una variabile che ad ogni ripetizione del cilco cambier├á
    if x != "fine":                                                                                     # se l'input sar├á diverso da "fine" questo ver├á salvato nella lista vuota che andr├á ad ampiarsi ad ogni ripetizione del ciclo
        my_list.append(x)
