...
for x in range(0, len(a)):                       # adopero un ciclo "for" con "x" (neccessaria nel caso degli interi) range ├¿ una funzione che attraverso i valori digitati nella parentesi iterer├á il ciclo partendo dalla posizione 0 fino a raggiungere l'ultimo elemento in "a" (len(a))
